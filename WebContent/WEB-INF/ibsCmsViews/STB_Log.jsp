...
<section id="content" class="container">
	...
	<a href="${pageContext.request.contextPath}/sedn/stb/log" style="padding-left:40px;padding-right:40px;font-weight:bold;color:#F8C529" class="active">OTT LOG</a>
        ...
        <div class="col-md-10">
			...
			<!--TITLE END-->
               ...
               <div class="pull-right p-5">
                    <button type="button" class="btn btn-default icon"><span>&#61844;</span> <span class="text">그룹 변경</span></button>
                    <button type="button" class="btn btn-default icon"><span>&#61943;</span> <span class="text">로그 추가</span></button>
                    <button type="button" class="btn btn-default icon"><span>&#61918;</span> <span class="text">로그  삭제</span></button>
              </div>
          	</div>
            <!-- CONTENTS START -->
...
<script>
	$(function() {
		//페이지 초기화
		contents.naviBar('stb-log', '', 'OTT LOG');
		menuJs.makeJsTree();
		contents.list('');
