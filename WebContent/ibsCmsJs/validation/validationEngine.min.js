        ...
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "minSize": {
                    "regex": "none",
                    "alertText": "최소 ",
                    "alertText2": " 자 이상 글자합니다."
                },
                "maxSize": {
                    "regex": "none",
                    "alertText": "최대 ",
                    "alertText2": " 자 이하 글자입니다."
                },
				"groupRequired": {
                    "regex": "none",
			...
			"func": function (field) {
			 ...
			 "alertText": "Invalid date, must be in YYYY-MM-DD"
                ...
                "onlyLetterNumber": {
                    "regex": /^.*(?=^.{6,15}$)(?=.*\d)(?=.*[a-zA-Z])(?=.*[!@#$%()^&+=]).*$/,
                    "alertText": "비밀번호는 최소 하나의 문자,하나의 숫자,하나의 특수 문자 포함, 최소 6자리 15이하이어야 합니다!"
                },
                // --- CUSTOM RULES -- Those are specific to the demos, they can be removed or changed to your likings
                "ajaxUserCall": {
                    "url": "/api/web/loginProcess?name=ok",
                ...
                "validate2fields": {
                    "alertEmail": "가입하지 않았거나 승인되지 않은 이메일입니다.",
                    "alertSchedule": "방송종료 시간이 방종시작시간보다 작거나 같을 수 없습니다.",
                    "alertPass": "비밀번호가 일치하지 않습니다.",
                    "alertExist":"가입되어 있는 이메일 입니다.",
                    "alertImage":"이미지를 업로드 하세요.",
                    "alertFile":"파일을 업로드 하세요."
                },
