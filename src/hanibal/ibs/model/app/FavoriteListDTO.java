...
public class FavoriteListDTO {
	...
	private String board_cate_idx;
	private String board_cate_name;
	private String vod_regdate;
	...
	public String getMain_thumbnail() {
		return main_thumbnail;
	}
	public void setMain_thumbnail(String main_thumbnail) {
		this.main_thumbnail = main_thumbnail;
	}
	public String getBoard_cate_idx() {
		return board_cate_idx;
	}
	public void setBoard_cate_idx(String board_cate_idx) {
		this.board_cate_idx = board_cate_idx;
	}
	...
	public String getVod_regdate() {
		return vod_regdate;
	}
	public void setVod_regdate(String vod_regdate) {
		this.vod_regdate = vod_regdate;
	}
}
